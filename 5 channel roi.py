...
def im_track(saveDir, check, csvName, Inclusion):
	...
	wr.writerow(['Spot_ID', 'Track_ID', 'Frame', 'X', 'Y', 'Z', 'Channel_1', 'Channel_2', 'Channel_3', 'Channel_4', 'Channel_5' 'Inclusion'])
	...
	for trackID in trackIDs:
	    ...
	    for spot in ls:
	        ...
	        l1 = (values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7], values[8], values[9], values[10], Inclusion)
	        wr.writerow(l1)
	myfile.close()
	IJ.selectWindow(orgtitle)
	IJ.run("Close")
