...
imp = IJ.getImage()
IJ.run(imp, "Subtract Background...", "rolling=50 sliding disable")
...
#IJ.run(imp, "Gaussian Blur...", "sigma=1.50")
...
settings.detectorSettings['RADIUS'] = 4.5
...
myfile = open('/Users/scottgrieshaber/Documents/'+orgtitle.split('.')[0]+'_ch1.csv', 'wb')
print(myfile)
